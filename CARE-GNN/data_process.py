...
if __name__ == "__main__":
	...
	yelp = loadmat('data/fraud.mat')
	net_rur = yelp['net_rur']
	net_rtr = yelp['net_rtr']
	net_rsr = yelp['net_rsr']
	yelp_homo = yelp['homo']

	sparse_to_adjlist(net_rur, prefix + 'fraud_rur_adjlists.pickle')
	sparse_to_adjlist(net_rtr, prefix + 'fraud_rtr_adjlists.pickle')
	sparse_to_adjlist(net_rsr, prefix + 'fraud_rsr_adjlists.pickle')
	sparse_to_adjlist(yelp_homo, prefix + 'fraud_homo_adjlists.pickle')
	print("finished")
'''
